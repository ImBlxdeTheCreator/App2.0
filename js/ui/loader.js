...
(function(){
  ...
  // Lightweight global notification utility. Account and live-sync modules
  // load before the Vault module, so the toast function must exist here.
  if(typeof window.fsToast!=='function'){
    window.fsToast=function(message,kind){
      const toast=document.createElement('div');
      toast.className='fsToast'+(kind?(' '+kind):'');
