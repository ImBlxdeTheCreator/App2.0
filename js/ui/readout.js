...
function renderCharacterStatsPanel(){
  ...
  const statsDisclaimer = el('div','empty-note', state.liveCharacterStats ? 'Live-synced totals come directly from Bungie’s CharacterComponent.stats, matching DIM’s character header.' : 'Without live sync, these values are calculated from the armor and tuning data currently selected in the builder.');
