...
(function(){
  ...
  window.D2Workspaces={activate,perform,get active(){return localStorage.getItem('d2synergy_workspace')||'builder';}};
  activate(localStorage.getItem('d2synergy_workspace')||'builder',{scroll:false});
})();
