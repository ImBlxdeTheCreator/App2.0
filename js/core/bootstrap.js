...
(function(){
  ...
  const BUILD='20260716-phase1-19-1-0';
  const groups={
    builder:{
      label:'Loading the build workspace',
      files:[
        'js/data/destiny-assets.js','js/data/subclasses.js','js/data/abilities.js','js/data/exotics.js',
        'js/data/weapons.js','js/data/armor.js','js/data/artifacts.js',
        'js/core/state.js','js/ui/themes.js','js/ui/status.js','js/ui/account-menu.js','js/core/synergy-engine.js','js/ui/builder.js',
