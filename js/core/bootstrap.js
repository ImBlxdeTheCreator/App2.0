/* D2Synergy staged bootstrap.
   v15 keeps the builder shell small, loads account code only for Bungie mode,
   and defers inventory/operations code until the related workspace opens. */
(function(){
  'use strict';

  const BUILD='20260715-activities-progress-15';
  const groups={
    builder:{
      ...
      files:[
        ...
        'js/core/state.js','js/core/synergy-engine.js','js/ui/builder.js',
  ...
  // Only hint the small builder group before the user chooses a launch mode.
  hintGroup('builder','low');
})();
