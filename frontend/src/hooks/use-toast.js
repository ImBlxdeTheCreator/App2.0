...
function useToast() {
  ...
  React.useEffect(() => {
    ...
    // React ref, so this subscription is intended to register once on mount
    // and clean up on unmount. Adding them to the deps array would cause the
    // effect to re-run every render and produce duplicate/stale listeners.
  }, [])
