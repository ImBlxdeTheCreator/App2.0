const CACHE='d2synergy-v19-0-5-stable';
const BUNGIE_ASSET_CACHE='d2synergy-bungie-assets-v19-0-5';
const VERSION='20260716-stable-19-0-5';
const FALLBACKS=[
...
const PRECACHE=[
  './','./index.html','./offline.html',`./manifest.webmanifest?v=19.0.5`,
