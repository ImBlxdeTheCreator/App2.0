const CACHE='d2synergy-shell-v14-performance-consolidation';
const VERSION='20260715-activities-progress-15';
...
const PRECACHE=[
  './','./index.html','./offline.html',`./manifest.webmanifest?v=14`,
