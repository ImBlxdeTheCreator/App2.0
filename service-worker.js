const CACHE='d2synergy-v19-1-1-phase1';
const BUNGIE_ASSET_CACHE='d2synergy-bungie-assets-v19-1-1';
const VERSION='20260716-phase1-19-1-1';
const FALLBACKS=[
...
const PRECACHE=[
  './','./index.html','./offline.html',`./manifest.webmanifest?v=19.1.1`,
